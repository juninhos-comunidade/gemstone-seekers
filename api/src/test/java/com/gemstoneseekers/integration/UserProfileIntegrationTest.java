...
class UserProfileIntegrationTest {
    ...
    void shouldReturnCandidateProfileAfterAuthenticationAndCompletion() {
        ...
        given().contentType(ContentType.JSON).header("Authorization", "Bearer " + authenticatedCandidate.token()).when()
            ...
            .body("result.candidate.summary", equalTo("Java Developer"))
    ...
    void shouldUpdateCandidatePersonalInfoAndReturnUpdatedProfile() {
        ...
        given().contentType(ContentType.JSON).header("Authorization", "Bearer " + authenticatedCandidate.token())
            ...
            .patch("/api/v1/profile/user").then().statusCode(200).body("success", equalTo(true))
            .body("message", equalTo("User info updated successfully"))
    ...
    void shouldUpdateCandidateAddressAndReturnUpdatedProfile() {
        ...
        given().contentType(ContentType.JSON).header("Authorization", "Bearer " + authenticatedCandidate.token())
            .body(addressBody).when()
            .patch("/api/v1/profile/address").then().statusCode(200).body("success", equalTo(true))
            .body("message", equalTo("Candidate address updated successfully"))
            ...
            .body("result.address.city.name", equalTo("São Paulo"))
            .body("result.address.city.stateId", equalTo(1));
    }
