...
class AuthIntegrationTest {
    ...
    static void setup() {
        ...
        app.setDefaultProperties(Map.of("spring.datasource.url", postgres.getJdbcUrl(), "spring.datasource.username",
                postgres.getUsername(), "spring.datasource.password", postgres.getPassword(), "server.port", "0"));
        context = app.run();
