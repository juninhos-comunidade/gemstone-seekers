...
public class BadgeMapper {
    ...
    public CandidateBadgeResponse toCandidateBadgeResponse(CandidateBadge candidateBadge) {
        ...
        return new CandidateBadgeResponse(
            candidateBadge.getBadge().getName(),
            candidateBadge.getBadge().getTechnology().getName(),
            candidateBadge.getBadge().getDescription(),
            candidateBadge.getAssesment().getScore(),
    ...
    public List<CandidateBadgeResponse> toCandidateBadgeListResponse(List<CandidateBadge> candidateBadgeList) {
        ...
        return candidateBadgeList.stream()
            .map(this::toCandidateBadgeResponse)
            .toList();
    }
    ...
    public AvailableBadgeResponse toAvailableBadgeResponse(Badge badge) {
        ...
        return new AvailableBadgeResponse(
            badge.getId(),
            badge.getName(),
            badge.getTechnology().getName(),
            badge.getDescription(),
            badge.getMinimumScore()
        );
    }
    ...
    public List<AvailableBadgeResponse> toAvailableBadgeListResponse(List<Badge> badgeList
        ...
        return badgeList.stream()
            .map(this::toAvailableBadgeResponse)
            .toList();
    }
}
