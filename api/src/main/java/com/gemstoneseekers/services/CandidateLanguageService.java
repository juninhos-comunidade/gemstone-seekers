...
public class CandidateLanguageService {
    ...
    public CandidateLanguageService(CandidateRepository candidateRepository, CandidateLanguageMapper candidateLanguageMapper, CandidateLanguageRepository candidateLanguagesRepository, LanguageRepository languageRepository) {
    ...
    public void deleteCandidateLanguage(String email, Integer languageId) {
        ...
        CandidateLanguage candidateLanguage = candidateLanguagesRepository.findById(idComposta)
            .orElseThrow(() -> new EntityNotFoundException("Language link not found for this candidate", languageId));
