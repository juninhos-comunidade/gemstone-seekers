...
export const questionarios = [
  ...
  },
  {
    ...
    Descricao:
      "Teste sobre closures, promises, event loop e conceitos avançados.",
    NumQuestoes: 3,
    Nivel: "avancado",
  },
  ...
  },
  {
    ...
    Descricao:
      "Teste sobre interfaces, generics, enums e tipos personalizados.",
    NumQuestoes: 3,
    Nivel: "intermediario",
  },
  {
  ...
  },
  {
    ...
    Descricao:
      "Teste sobre funções, módulos, orientação a objetos e tratamento de erros.",
    NumQuestoes: 3,
    Nivel: "intermediario",
  },
  {
    ...
    Descricao:
      "Teste sobre decorators, generators, threads e programação assíncrona.",
    NumQuestoes: 3,
    Nivel: "avancado",
  },
  ...
  },
  {
    ...
    Descricao:
      "Teste sobre streams, generics, concorrência e padrões de projeto.",
    NumQuestoes: 3,
    Nivel: "avancado",
  },
  ...
  },
  {
    ...
    Descricao:
      "Teste sobre performance, memoização, arquitetura e renderização.",
    NumQuestoes: 3,
    Nivel: "avancado",
  },
  ...
  },
  {
    ...
    Descricao:
      "Teste sobre autenticação JWT, streams, workers e escalabilidade.",
    NumQuestoes: 3,
    Nivel: "avancado",
  },
  ...
  // Git
  {
    ...
    Descricao:
      "Teste sobre repositórios, commits, branches e comandos básicos.",
    NumQuestoes: 3,
    Nivel: "iniciante",
  },
  {
    ...
    Descricao:
      "Teste sobre merge, rebase, stash, tags e resolução de conflitos.",
    NumQuestoes: 3,
    Nivel: "intermediario",
  },
  {
    ...
    Titulo: "Git Avançado",
    Descricao:
      "Teste sobre Git Flow, hooks, cherry-pick e estratégias avançadas.",
    NumQuestoes: 3,
    Nivel: "avancado",
  },
  ...
  },
  {
    ...
    Descricao:
      "Teste sobre relacionamentos, JOINs, filtros e funções de agregação.",
    NumQuestoes: 3,
    Nivel: "intermediario",
  },
  {
    ...
    Titulo: "SQL Avançado",
    Descricao:
      "Teste sobre subconsultas, views, índices, procedures e otimização.",
    NumQuestoes: 3,
    Nivel: "avancado",
  },
];
